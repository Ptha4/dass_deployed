...
export default function NotificationsDropdown() {
  ...
  const markAllAsRead = async () => {
    ...
    try {
      await Promise.all([
        axios.post("https://dass-deployed.onrender.com/api/notifications/read-all", {}, { headers }),
        axios.post("https://dass-deployed.onrender.com/api/notifications/batches/read-all", {}, { headers }),
      ]);
