...
export function WelcomeHeader({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 via-white to-white rounded-2xl p-8 border border-blue-100 shadow-sm mb-8">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              variant="outline"
              size="sm"
              className="bg-white shadow-sm hover:shadow-md transition-shadow border-blue-200 text-gray-700 font-medium group"
              onClick={() => router.push("/experts")}
            >
              <Search className="h-4 w-4 mr-2 text-blue-600 group-hover:scale-110 transition-transform" />
              Find Mentor
            </Button>
            <Button
              variant="outline"
              size="sm"
              className="bg-white shadow-sm hover:shadow-md transition-shadow border-purple-200 text-gray-700 font-medium group"
        ...
        <div className="lg:min-w-[280px]">
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-indigo-100 shadow-sm">
